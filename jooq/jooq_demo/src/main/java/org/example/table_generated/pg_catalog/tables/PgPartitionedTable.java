...
public class PgPartitionedTable extends TableImpl<PgPartitionedTableRecord> {
     ...
     */
    public final TableField<PgPartitionedTableRecord, Object[]> PARTATTRS = createField(DSL.name("partattrs"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").nullable(false).array(), this, "");

    /**
     * The column <code>pg_catalog.pg_partitioned_table.partclass</code>.
     */
    public final TableField<PgPartitionedTableRecord, Object[]> PARTCLASS = createField(DSL.name("partclass"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").nullable(false).array(), this, "");

    /**
     * The column <code>pg_catalog.pg_partitioned_table.partcollation</code>.
     */
    public final TableField<PgPartitionedTableRecord, Object[]> PARTCOLLATION = createField(DSL.name("partcollation"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").nullable(false).array(), this, "");
